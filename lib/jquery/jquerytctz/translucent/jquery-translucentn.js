...
; (function ($, window, document, undefined) {
    ...
    Translucent.prototype = {
        ...
        drawInfoWindow: function () {
            ...
            var html = '';
            //<img id="translucent_big" title="最大化" src="' + 'lib/jquery/jquerytctz/icon/big.png"/>
            html += '<div id="' + context.config.target + '" class="translucent-container">';
            html += '<div class="translucent-title"><span>' + context.config.titleText + '</span><div class="translucent-control"><img id="translucent_small" title="最小化" src="' + 'lib/jquery/jquerytctz/icon/small.png"/><img id="translucent_close" title="关闭" src="' + 'lib/jquery/jquerytctz/icon/close.png"/></div></div>';
        ...
        smallWindow: function () {
            ...
            $("#translucent_small").bind("click", function (e) {
                ...
                if (context.defaults._isScale) {
                    ...
                    $(this).attr("src", "lib/jquery/jquerytctz/icon/fangda.png");
                    $(this).attr("title", "还原");
                    //$("#translucent_big").attr("src", "lib/jquery/jquerytctz/icon/big.png");
                    ...
                    $(this).attr("src", "lib/jquery/jquerytctz/icon/small.png");
                    $(this).attr("title", "最小化");
                    context.defaults._isScale = true;
                }
                e.preventDefault();  //阻止默认事件
        ...
        maxWindow: function () {
            ...
            translucentBig.bind("click", function (e) {
                ...
                if (context.defaults._isMax) {
                    ...
                    $(this).attr("src", "lib/jquery/jquerytctz/icon/huanyuan.png");
                    $(this).attr("title", "还原");
                    ...
                    $(this).attr("src", "lib/jquery/jquerytctz/icon/big.png");
                    $(this).attr("title", "最大化");
