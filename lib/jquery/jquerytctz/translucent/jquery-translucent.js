        ...
        drawInfoWindow:function () {
            ...
            var html = '';
                html += '<div id="'+context.config.target+'" class="translucent-container">';
                    html += '<div class="translucent-title"><span>'+context.config.titleText+'</span><div class="translucent-control"><img id="translucent_small" title="最小化" src="'+'icon/small.png"/><img id="translucent_big" title="最大化" src="'+'icon/big.png"/><img id="translucent_close" title="关闭" src="'+'icon/close.png"/></div></div>';
